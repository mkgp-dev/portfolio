...
import { EXPERIENCE_LIST } from "@/constants/about";
...
export default function AboutExperience() {
    ...
    return (
        <Card className="relative rounded-none">
            <CardContent>
                <Badge className="absolute right-4 top-4 bg-blue-600 text-white">Experience</Badge>

                <div className="divide-y divide-border">
                    {EXPERIENCE_LIST.map((item: AboutDefinition, index: number) => (
