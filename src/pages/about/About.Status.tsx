...
import { STATUS_LIST } from "@/constants/about";
...
export default function AboutStatus() {
    ...
    return (
        <Card className="relative rounded-none">
            <CardContent>
                <Badge className="absolute right-4 top-4 bg-blue-600 text-white">Current status</Badge>

                <div className="divide-y divide-border">
                    {STATUS_LIST.map((item: AboutDefinition, index: number) => (
